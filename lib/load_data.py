...
def load_data(args):
    ...
    if args.dataset_type == 'llff':
        images, depths, poses, bds, render_poses, i_test, features = load_llff_data(
        ...
        images, poses, render_poses, hwf, i_split, features = load_blender_data(args.datadir, args.half_res, args.testskip, args=args)
        ...
        images, poses, render_poses, hwf, K, i_split, features = load_tankstemple_data(
...
#        i_test = [0]
        ...
        images, poses, render_poses, hwf, i_split, features = load_replica_data(args.datadir, args.half_res, args.testskip, args=args)
